                ...
                <div class="panel-body">
                    <form action="/user/profile" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="firstName" value=" <#if user??>${user.firstName}</#if>" required>
                        </div>
                        <div class="form-group">
                            <label ><@spring.message "last.name"/></label>
                            <input type="text" class="form-control" name="lastName" value=" <#if user??>${user.lastName}</#if>" required>
                        </div>
                        <div class="form-group">
