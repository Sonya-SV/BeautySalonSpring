...
<div class="container" style="margin-top: 60px">
    <div class="col-md-10    col-md-offset-1" style="padding-top: 50px">
        <h2 align="center"> <@spring.message "reviews"/></h2>
        <div class="comments">
...
<#--                </c:if>-->
                <textarea required rows="4" cols="100%" name="comment"
                          placeholder="<@spring.message "put.your.comment"/>"></textarea>
            ...
            <#if comments??>
<#--            <h5>${comments?counter}  <@spring.message "comments"/></h5>-->
